  ...
  return (
    <div className="space-y-6">
      ...
      {filteredDocuments.length === 0 ? (
          ...
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              {searchQuery || statusFilter !== "all"
                ...
                : "Create your first document to get started with Lawverra"}
            </p>
            {!searchQuery && statusFilter === "all" && (
              <Button asChild className="bg-primary hover:bg-primary/90">
                <Link href="/create">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 min-w-0">
              ...
              <CardContent className="pt-0">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center space-x-2 text-sm text-muted-foreground min-w-0 flex-1">
                    ...
                    <span className="truncate">Updated {formatDate(doc.updated_at)}</span>
                  </div>
